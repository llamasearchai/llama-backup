# Contributing to Llama Backup

Thank you for your interest in contributing to Llama Backup! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Backup:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-backup.git
   cd llama-backup
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-backup.git
   ```
...
By contributing to Llama Backup, you agree that your contributions will be licensed under the project's MIT License.
